...
namespace GUI.Rlc
{
    class RShape : AbstractRLCShape
    {
        private RLCbranches branch;
        public RShape()
        {
            this.Name = "RShape";
            this.DiagramShapeElement.Image = Properties.Resources.resistor;
        ...
        {
            IRlcBL r = new RBL();
            branch = (R)r.add(base.cases);
            branch.branch = "R";
            label.Text = "R " + branch.number;
        ...
        {
            this.label.Text = long.TryParse(name, out _) ? "R " + name : name;
        }
