...
namespace GUI.Rlc
{
    class CShape : AbstractRLCShape
    {
        ...
        {
            this.Name = "CShape";
            this.DiagramShapeElement.Image = Properties.Resources.capacitor;
        ...
        {
            IRlcBL c = new CBL();
            branch = (C)c.add(base.cases);
            branch.branch = "C";
            label.Text = "C " + branch.number;
        ...
        {
            this.label.Text = long.TryParse(name, out _) ? "C " + name : name;
        }
