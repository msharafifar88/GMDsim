...
namespace GUI.Rlc
{
    class LCShape : AbstractRLCShape
    {
        private RLCbranches branch;
        public LCShape()
        {
            this.Name = "LCShape";
            this.DiagramShapeElement.Image = Properties.Resources.lc1;
        ...
        {
            IRlcBL lc = new LcBL();
            branch = (LC)lc.add(base.cases);
            branch.branch = "LC";
            label.Text = "LC " + branch.number;
        ...
        {
            this.label.Text = long.TryParse(name, out _) ? "LC " + name : name;
        }
