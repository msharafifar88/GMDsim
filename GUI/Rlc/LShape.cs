...
namespace GUI.Rlc
{
    class LShape : AbstractRLCShape
    {
        private RLCbranches branch;
        public LShape()
        {
            this.Name = "LShape";
            this.DiagramShapeElement.Image = Properties.Resources.coil;
        ...
        {
            IRlcBL l = new LBL();
            branch = (L)l.add(base.cases);
            branch.branch = "L";
            label.Text = "L " + branch.number;
        ...
        {
            this.label.Text = long.TryParse(name, out _) ? "L " + name : name; ;
        }
