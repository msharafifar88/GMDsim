...
{
    class YgDTShape : AbstractTShape, IDiagramShape
    {
        private MainTransformers transformerTypes;
        private string urlImg = "/Image/YgD.png";
        private int xDim = 45, yDim = 70;

        public YgDTShape()
        {
            this.Name = "YgDTransformerShape";
            ...
            this.setStyles(45, 70);
        }

        public YgDTShape(bool isCloneOne)
        {
        ...
        {
            ITransformer iTransformer = new YgDTransformerBL();
            transformerTypes = (YgDTransformer)iTransformer.add(base.cases);
            transformerTypes.type = "YgD";
            label.Content = "YgD " + transformerTypes.number;
        ...
        {
            this.label.Content = long.TryParse(name, out _) ? "YgD " + name : name;
        }
        ...
        {
            YgDTShape clonedObject = new YgDTShape(true);
