...
{
    class RLCShape : AbstractRLCCShape, ICloneable, IDiagramShape
    {
        private RLCbranches rlcBranches;
        private string urlImg = "/Image/rlc.png";
        private int xDim = 29, yDim = 50;
        ...
        public RLCShape()
        {
            ...
            this.setStyles(29, 50);
        }

        public RLCShape(bool isCloneOne)
        {
        ...
        private void createChildElements()
        {
            ...
            rlcBranches = (network.RLC)rlcBL.add(base.cases);
            rlcBranches.branch = "RLC";
            label.Content = "RLC " + rlcBranches.number;
        ...
        {
            this.label.Content = long.TryParse(name, out _) ? "RLC " + name : name; ;
        }
        ...
        public override object Clone()
        {
            ...
            RLCShape clonedObject = new RLCShape(true);
