...
{
    class LShape : AbstractRLCCShape, ICloneable, IDiagramShape
    {
        private RLCbranches rlcBranches;
        private string urlImg = "/Image/coil.png";
        ...
        {
            IRlcBL lBL = new LBL();
            rlcBranches = (L)lBL.add(base.cases);
            rlcBranches.branch = "L";
            label.Content = "L " + rlcBranches.number;
        ...
        {
            this.label.Content = long.TryParse(name, out _) ? "L " + name : name;
        }
        ...
        public override object Clone()
        {
            ...
            LShape clonedObject = new LShape(true);
