...
{
    class LCShape : AbstractRLCCShape, ICloneable, IDiagramShape
    {
        private RLCbranches rlcBranches;
        private string urlImg = "/Image/lc1.png";
        ...
        public LCShape(bool isCloneOne)
        {
        ...
        {
            IRlcBL lcBL = new LcBL();
            rlcBranches = (LC)lcBL.add(base.cases);
            rlcBranches.branch = "LC";
            label.Content = "LC " + rlcBranches.number;
        ...
        public override object Clone()
        {
            ...
            LCShape clonedObject = new LCShape(true);
