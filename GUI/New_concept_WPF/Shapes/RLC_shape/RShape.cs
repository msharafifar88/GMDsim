...
{
    class RShape : AbstractRLCCShape, ICloneable, IDiagramShape
    {
        private RLCbranches rlcBranches;
        private string urlImg = "/Image/resistor.png";
        ...
        {
            IRlcBL rBL = new RBL();
            rlcBranches = (R)rBL.add(base.cases);
            rlcBranches.branch = "R";
            label.Content = "R " + rlcBranches.number;
        ...
        {
            this.label.Content = long.TryParse(name, out _) ? "R " + name : name; ;
        }
        ...
        public override object Clone()
        {
            ...
            RShape clonedObject = new RShape(true);
