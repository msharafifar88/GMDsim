...
{
    public class MphaseShape : NodeViewModel, ICloneable, IDiagramShape
    {
        private Case cases;
        private MultiPhaseLine multiPhaseLineitem;
        ...
        public MphaseShape(bool isCloneOne)
        {
        ...
        private void createChildElements()
        {
            ...
            multiPhaseLineitem = multiPhaseLineBL.addLine(this.cases);

            multiPhaseLineitem.Branch = "Mphase";
            label.Content = "Mphase" + multiPhaseLineitem.Number;
            label.Offset = new System.Windows.Point(-0.5, 0);
            //Margin = new System.Windows.Thickness(23, 10, 0, 0),
            label2.Content = multiPhaseLineitem.Number;
        ...
        public MultiPhaseLine GetMMltiPhaseLine()
        {
            return multiPhaseLineitem;
        }

        public void setDoubleCircuitLine(MultiPhaseLine line)
        {
            this.multiPhaseLineitem = line;
        }

        public void setLabel(string name)
        {
            this.label.Content = long.TryParse(name, out _) ? "Mphase " + name : name;
        }
        ...
        public object Clone()
        {
            ...
            MphaseShape clonedObject = new MphaseShape(true);
            clonedObject.cases = this.cases;
            clonedObject.multiPhaseLineitem = this.multiPhaseLineitem;
            return clonedObject;
        }
    }
}
