...
{
    public class Singleline3phaseShape : NodeViewModel, ICloneable, IDiagramShape
    {
        private Case cases;
        private Single3phaseLine single3phaseLineitem;
        private string urlImg = "/Image/monophasic_line.png";
        private bool isClonedOne;
        private int xDim = 10, yDim = 70;

        public Singleline3phaseShape()
        {
            this.cases = CustomContentControl.getCurrentCase();
            this.Name = "Single3phaseLineShape";
        ...
        public Singleline3phaseShape(bool isCloneOne)
        {
        ...
        private void createChildElements()
        {
            ...
            single3phaseLineitem.Branch = "SinglePhase";
            label.Content = "3phase" + single3phaseLineitem.Number;
        ...
        public Single3phaseLine GetSingle3PhaseLine()
        {
            return single3phaseLineitem;
        }

        public void setSingle3phasetLine(Single3phaseLine line)
        {
        ...
        {
            this.label.Content = long.TryParse(name, out _) ? "3phase " + name : name;
        }
        ...
        public object Clone()
        {
            ...
            Singleline3phaseShape clonedObject = new Singleline3phaseShape(true);
