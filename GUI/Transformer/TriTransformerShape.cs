...
{
    class TriTransformerShape : AbstractTRShape
    {
        private MainTransformers transformerTypes;
        public TriTransformerShape()
        {
            this.Name = "TriTransformerShape";
            this.UseDefaultConnectors = false;
            this.DiagramShapeElement.Image = Properties.Resources.triphasic_transformer;
        ...
        private void customConnectors()
        {
            ...
            {
                Offset = new Telerik.Windows.Diagrams.Core.Point(1, 0.49),
                Name = this.Name + "Conn_2"
            };
            RadDiagramConnector conn_3 = new RadDiagramConnector()
            {
                Offset = new Telerik.Windows.Diagrams.Core.Point(0.21, 0.79),
        ...
        protected new void CreateChildElements()
        {
            ...
            ITransformer iTransformer = new TriTransformerBL();
            transformerTypes = (TriTransformer)iTransformer.add(base.cases);
            transformerTypes.type = "3Tra";
            label.Text = "3Tra " + transformerTypes.number;
        ...
        {
            this.label.Text = long.TryParse(name, out _) ? "3Tra " + name : name;
        }
