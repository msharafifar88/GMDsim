...
{
    class YgYgDTransformerShape : AbstractTRShape
    {
   
        private MainTransformers transformerTypes;
        public YgYgDTransformerShape()
        {
            this.Name = "YgYgDTransformerShape";
            this.UseDefaultConnectors = false;
            this.DiagramShapeElement.Image = Properties.Resources.YgYgD_transformer;
        ...
        protected new void CreateChildElements()
        {
            ...
            label.Text = "YgYgD " + transformerTypes.number;
        ...
        {
            this.label.Text = long.TryParse(name, out _) ? "YgYgD " + name : name;
        }
